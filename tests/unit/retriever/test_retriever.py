...
from sophos_rag.retriever.vector_store import VectorStore
from sophos_rag.retriever.search import Retriever, SimpleRetriever, MMRRetriever
...
class TestRetrieverFactory(unittest.TestCase):
    ...
    def test_get_simple_retriever(self):
        ...
        from sophos_rag.retriever.search import get_retriever
