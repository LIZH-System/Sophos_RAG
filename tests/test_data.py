...
from src.data.loader import DataLoader, FileLoader, get_loader
from src.data.processor import DocumentProcessor, TextCleaner, create_default_pipeline
from src.data.splitter import TextSplitter, RecursiveCharacterTextSplitter, get_text_splitter
...
class TestTextSplitter(unittest.TestCase):
    ...
    def setUp(self):
        """Set up the test environment."""
        self.config = {"chunk_size": 10, "chunk_overlap": 2}
    ...
    def test_split_documents(self):
        ...
        documents = [
            {"content": "This is a test document that needs to be split into chunks.", "source": "test.txt"},
            {"content": "This is another document.", "source": "test2.txt"}
        ]
